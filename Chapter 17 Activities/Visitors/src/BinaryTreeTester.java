...
public class BinaryTreeTester {
    public static void main(String[] args) {
        ...
        BinaryTree names = new BinaryTree("Juliet", new BinaryTree("Diana", new BinaryTree(), new BinaryTree("Harry")),
                new BinaryTree("Tom", new BinaryTree("Romeo"), new BinaryTree()));

        /*
         * This is an example of a Lambda expression.
         * 
         * Lamba expressions were added in Java 8. They are popular in a variety of
         * dynamic languages and may be referred to as closures, anonymous functions, or
         * blocks. They require little syntax (they are very concise).
         * 
