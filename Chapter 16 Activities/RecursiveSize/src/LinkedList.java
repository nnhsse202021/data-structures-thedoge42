 ...
 * the number of elements in the list by recursively by calling a recursive
 * helper method private static int size(Node start) Hint: If start is null,
 * then the size is 0. Otherwise, it is one larger than the size of start.next.
 */
